...
const ImageSlider = ({ imageList }: Props) => {
  ...
  // Đúng cú pháp: "onViewableItemsChanged" thay vì "onViewableItemChanged"
  ...
  // Đúng cú pháp: "itemVisiblePercentThreshold" thay vì "itemVisiblePercentTherhold"
  const viewabilityConfig = {
    itemVisiblePercentThreshold: 50,
  }

  // Sử dụng onViewableItemsChanged thay vì onViewableItemChanged
